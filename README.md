...
- **Gates, no harness needed:** `pnpm check` (2208 contrast rows plus invariants) and `pnpm test` (23 behavioral assertions, including a load-time lock on `lib/client.js`).
